...
BattleVictoryScene::BattleVictoryScene(GameStateManager* gameState)
...
void BattleVictoryScene::render(SpriteRenderer* spriteRenderer, TextRenderer* textRenderer) {
